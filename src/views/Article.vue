	  	...
	  	<div class="article__comments comments">
	  		<form class="comments__form">
	  			...
	  			<div class="comments__button">
	  				<button @click="submitComment">Оставить комментарий</button>
	  			</div>
	  		</form>
	  			<div class="comment">

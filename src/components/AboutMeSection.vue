  ...
  <section class="aboutMe" id="aboutMe">
    ...
    <div class="aboutMe__info info">
      ...
      <div class="info__text">
        <p>Занимаюсь разработкой сайтов, опыт работы более 3 лет. Создаю интернет-ресурсы как с использованием готовых шаблонов, так и воплощая уникальный и оригинальный дизайн с индивидуальным подходом к кажому клиенту. Строго придерживаюсь сроков исполнения, гарантия на сайт по договору.</p>
      </div>
    </div>
